...
const MARKET_RESEARCH_NICHES: NicheItem[] = [
  ...
  },
  {
    ...
    dataQuality: "verified",
    topCandidate: "Vegan Snacks (điểm cao nhất nhưng CPG dễ hỏng, không hợp dropship) — Beeswax Wraps là lựa chọn thực tế hơn",
    topScore: "8/10",
  },
  {
    num: 3,
  ...
  },
  {
    ...
    dataQuality: "verified",
    topCandidate: "Baby Bottles — nhưng Teething Toys (7/10) evergreen nhất trong CẢ 4 báo cáo verified",
    topScore: "8/10",
  },
  {
    num: 6,
    ...
    fullPath: "/Users/aminhp93/personal/dropship/workspace/doc/1-market-research/6-press-on-nails.md",
    altPath: "6-press-on-nails-niche-report.html",
    altFullPath: "/Users/aminhp93/personal/dropship/workspace/doc/1-market-research/6-press-on-nails-niche-report.html",
...
const COMPETITOR_BENCHMARK_STORES: CompetitorStore[] = [
  {
    ...
    theme: "\"NailHandy Clean 2026-08\" (theme custom — KHÔNG xác nhận được là Shrine PRO)",
    ...
    margin: "PPSPY ước tính chung ~75% (công thức mặc định của tool, chưa xác minh với supplier thật)",
    offer: "Bundle theo set (vd: 12-set Halloween $270.53) — chưa xác nhận cơ chế Buy 2 Get 1",
    uxTriggers: [
    ...
    trafficChannels: "Có Meta Pixel + TikTok Pixel active — số lượng ads đang chạy CHƯA XÁC MINH (cần check tay Meta Ads Library, không suy từ pixel)",
    adsLibraryUrl: "https://www.facebook.com/ads/library/?active_status=all&ad_type=all&country=US&q=nailhandy",
    tiktokUrl: "https://www.tiktok.com/search?q=nailhandy%20press%20on%20nails",
    igUrl: "https://www.instagram.com/nailhandy_official/",
    logistics: "Chưa xác minh (giả định YunExpress dựa trên hình mẫu chung ngành, không phải data sourced)",
    rating: "Chưa chấm điểm lại — điểm 9.8/10 trước đó dựa trên data sai, cần đánh giá lại",
    takeaway: "App Loox Photo Reviews + pricing theo bundle-set (không phải giá lẻ thấp) là 2 tín hiệu sourced đáng tin để tham khảo.",
  },
  {
    name: "Lovful",
    url: "https://lovful.com/",
    role: "Fast-Fashion Acrylic (High-Volume DTC)",
    theme: "\"Prestige Theme (Luxury)\" + app PageFly Page Builder (xác nhận qua PPSPY — KHÔNG phải \"Beae\")",
    pricing: "$33.99 – $37.99 / set (avg $37.83) — cao hơn nhiều so với con số $14.99-$22.99 đã ghi trước đó",
    ...
    offer: "Giảm giá bậc thang theo tag ('A-discounty', 'SPRING Event Sale') — chưa xác nhận % cụ thể",
    uxTriggers: [
    ...
    trafficChannels: "Có Meta Pixel active thật — KHÔNG thể kết luận '0 Ads Meta' chỉ vì search không ra kết quả trên Ads Library (tool hạn chế với advertiser nhỏ, đã ghi chú tương tự ở market-research-runs.json)",
    adsLibraryUrl: "https://www.facebook.com/ads/library/?active_status=all&ad_type=all&country=US&is_targeted_country=false&media_type=all&q=lovful&search_type=keyword_unordered&sort_data[mode]=total_impressions&sort_data[direction]=desc",
    tiktokUrl: "https://www.tiktok.com/search?q=lovful%20nails",
    logistics: "Chưa xác minh (giả định, không phải data sourced)",
    rating: "Chưa chấm điểm lại — điểm 8.8/10 trước đó dựa trên data sai, cần đánh giá lại",
    takeaway: "Giá bán thật ($33-38) gần với NailHandy hơn nhiều so với ghi chú cũ — đừng dùng con số giá thấp cũ để định vị giá cho store của mình.",
  },
  {
    name: "KISS USA",
    url: "https://www.kissusa.com/",
    role: "Global Retail Leader (Industry Standard)",
    theme: "\"shopify-kiss/main\" (theme nội bộ tự dựng — KHÔNG phải \"Be Yours v8.3.3\")",
    pricing: "$3.99 – $100.00 / SKU (avg $11.78) — có tier BYOB bundle tới $100, chưa từng ghi ở bản cũ",
    cogs: "Không có báo giá supplier thật — est_cogs PPSPY ~25% giá bán (công thức mặc định)",
    margin: "PPSPY ước tính chung ~75% (mặc định của tool)",
    offer: "Có dòng 'Build Your Own Bundle' (BYOB) giá cao — chưa xác nhận Subscribe & Save",
    uxTriggers: [
    ...
    trafficChannels: "Pixel ID xác nhận Active — số lượng/ngân sách ads thật vẫn CHƯA XÁC MINH qua tool nào đang có",
    adsLibraryUrl: "https://www.facebook.com/ads/library/?active_status=all&ad_type=all&country=US&q=kiss%20products",
    tiktokUrl: "https://www.tiktok.com/@kissproducts",
    logistics: "Chưa xác minh (giả định kho nội địa Mỹ dựa trên quy mô thương hiệu, không phải data sourced)",
    rating: "Chưa chấm điểm lại — điểm 9.2/10 trước đó dựa trên data sai, cần đánh giá lại",
    takeaway: "Đây là brand retail lớn (giá thấp, SKU rộng) — mức độ tham khảo cho 1 store solo mới thấp hơn 2 store kia.",
  },
];
...
Không có tiến độ mới cho Handmade Press-On Nails (vẫn đang chờ search tay lại Meta Ads Library/Trends theo đúng chuẩn 3 báo cáo verified, như đã note ở phần So sánh 6 ngách bên trên) — hôm nay là ngày mở rộng phạm vi benchmark, không phải ngày đóng gap đó lại.`,
  },
  {
    id: "2026-08-28",
    date: "28/08/2026",
    title: "TOP 2: Bóc Tách & Nghiên Cứu Chi Tiết 3 Store Mẫu (Lovful, KISS USA, NailHandy)",
    isLatest: false,
    ...
    <Card className="p-5 border-zinc-200 dark:border-zinc-800 space-y-4">
      <div>
        ...
        <p className="text-[11px] text-zinc-500 dark:text-zinc-400 mt-0.5">
          Hồ sơ: solo newbie, chưa có brand/audience sẵn có, vốn $3.000. Đây là bộ tiêu chí đã
          dùng để research + chấm điểm cả 6 ngách bên dưới — không phải tiêu chí chung chung.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div className="p-3 rounded-lg border border-red-500/25 bg-red-500/5 space-y-1.5">
          ...
          <p className="text-[11px] text-zinc-700 dark:text-zinc-300 leading-relaxed">
            <strong>1. Đang là trend</strong> — nhu cầu chỉ do 1 đợt viral/mùa vụ ngắn, không phải
            nhu cầu quanh năm (check Trends 12 tháng, ưu tiên baseline phẳng-hoặc-tăng hơn 1 đỉnh
            nhọn).
          </p>
          <p className="text-[11px] text-zinc-700 dark:text-zinc-300 leading-relaxed">
            <strong>2. Ngách thắng nhờ brand cá nhân/local</strong> — người bán top đầu thắng vì có
            sẵn founder/nội dung/lượng follow riêng, không phải vì ai nhập hàng + chạy ads cũng
            thắng được như nhau.
          </p>
        </div>
        ...
        <div className="p-3 rounded-lg border border-emerald-500/25 bg-emerald-500/5 space-y-1.5">
          ...
          <p className="text-[11px] text-zinc-700 dark:text-zinc-300 leading-relaxed">
            <strong>1. Wow factor</strong> — gây chú ý trong 3 giây đầu video ngắn.
          </p>
          <p className="text-[11px] text-zinc-700 dark:text-zinc-300 leading-relaxed">
            <strong>2. Giải quyết nỗi đau thật</strong> — vấn đề cụ thể, không mơ hồ.
          </p>
          <p className="text-[11px] text-zinc-700 dark:text-zinc-300 leading-relaxed">
            <strong>3. Margin dày</strong> — giá bán ≥ 3-4x COGS, gross margin ≥ 75-80%.
          </p>
          <p className="text-[11px] text-zinc-700 dark:text-zinc-300 leading-relaxed">
            <strong>4. Dễ ship</strong> — &lt;500g, không pin lớn/chất lỏng/dễ vỡ, ship &lt;15 ngày.
          </p>
        </div>
      </div>
    </Card>
  ...
  return (
    <Card className="p-5 border-emerald-500/30 bg-emerald-500/5 dark:bg-emerald-950/10 space-y-4">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-[11px] text-zinc-600 dark:text-zinc-400">
            4/6 ngách đọc được thật (2 ngách chỉ có file .gdoc — xem danh sách bên dưới). Cột "Độ tin cậy" là điều quan trọng nhất ở đây.
          </p>
        </div>
      </div>
            ...
            {NICHE_VERDICTS.map((v) => {
              ...
              return (
                <tr key={v.niche} className="align-top">
                  <td className="p-2 font-bold text-zinc-900 dark:text-zinc-100 whitespace-nowrap">{v.niche}</td>
                  <td className="p-2 text-zinc-700 dark:text-zinc-300">{v.candidate}</td>
                  <td className="p-2 font-mono text-zinc-600 dark:text-zinc-400 whitespace-nowrap">{v.score}</td>
                  <td className="p-2">
                    <Badge variant="outline" className={cn("text-[10px] font-bold whitespace-nowrap", q.cls)}>
                      {q.label}
                    </Badge>
                  </td>
                </tr>
      ...
      <div className="space-y-2 pt-1">
        {NICHE_VERDICTS.map((v) => (
          <div key={v.niche} className="p-2.5 rounded-lg bg-white/60 dark:bg-zinc-900/40 border border-zinc-200/60 dark:border-zinc-800 text-[11px] leading-relaxed">
            <span className="font-bold text-zinc-900 dark:text-zinc-100">{v.niche} — {v.candidate}: </span>
            <span className="text-zinc-600 dark:text-zinc-400">{v.fit}</span>{" "}
            <span className="text-amber-700 dark:text-amber-400">⚠️ {v.risk}</span>
          </div>
        ))}
      </div>

      <div className="p-3.5 rounded-xl bg-emerald-600/10 border border-emerald-500/30 space-y-1.5">
        <p className="text-xs font-bold text-emerald-800 dark:text-emerald-300">💡 Khuyến nghị</p>
        <p className="text-[11px] text-zinc-700 dark:text-zinc-300 leading-relaxed">
          Nếu chấm đúng theo tiêu chí cũ (evergreen, nhẹ, không pin/lỏng, chưa bị brand độc chiếm) trên riêng 4 báo cáo <strong>đã verified</strong> (bỏ Home & Bedroom và Press-On Nails vì data chưa kiểm chứng), <strong>Teething Toys</strong> khớp nhiều tiêu chí nhất nhưng chưa từng được cân nhắc, còn <strong>Seat Covers & Organizers</strong> có bằng chứng "đối thủ đang có lãi" mạnh nhất (7.000 advertiser thật). Cả hai đều đáng cân nhắc hơn 2 ngách đang tốn nhiều công sức nhất gần đây (Home & Bedroom, Nails) — vì 2 ngách đó có data yếu hơn, chưa phải vì bản thân sản phẩm tệ.
        </p>
        <p className="text-[11px] text-zinc-700 dark:text-zinc-300 leading-relaxed">
          Nếu vẫn muốn đi tiếp Nails (đã đầu tư nhiều công sức benchmark 3 store) — việc cần làm trước khi chốt là lặp lại đúng quy trình 4 nguồn live (Trends/Shopping/TikTok/Meta Ads, có trích dẫn ngày giờ cụ thể) cho riêng "Handmade Press-On Nails", giống hệt cách đã làm cho Car Accessories/Sustainability/Child & Baby — hiện tại ngách này là ngách duy nhất đang tốn công sức nhiều nhất mà data nhu cầu thị trường lại yếu nhất.
        </p>
      </div>
      ...
      <div className="space-y-3 pt-1 border-t border-emerald-500/20">
        <div className="flex items-center justify-between pt-2">
          ...
          >
            {showCompetitors ? (
              <>
                <ChevronDown className="w-4 h-4 mr-1.5 text-rose-500" /> Thu gọn 3 Store Mẫu Mục Tiêu (NailHandy · Lovful · KISS USA)
              </>
            ) : (
              <>
                <ChevronRight className="w-4 h-4 mr-1.5 text-rose-500" /> 💅 Xem Bóc Tách 3 Store Mẫu Mục Tiêu (NailHandy · Lovful · KISS USA)
              </>
            )}
          </Button>
        </div>
                ...
                >
                  ...
                  <div className="flex-1 space-y-1.5">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <Badge
                        variant="outline"
                        className={cn("text-[10px] font-bold", dataQualityBadge(n.dataQuality).cls)}
                      >
                        {dataQualityBadge(n.dataQuality).label}
                      </Badge>
                      {n.topCandidate && (
                        <span className="text-[11px] text-zinc-500 dark:text-zinc-400">
                          Top: <strong className="text-zinc-700 dark:text-zinc-300">{n.topCandidate}</strong>
                          {n.topScore && n.topScore !== "—" && ` (${n.topScore})`}
                        </span>
                      )}
                    </div>
        ...
        <div className="flex items-center justify-between flex-wrap gap-2">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-zinc-600 dark:text-zinc-400">
                NailHandy (Top 1 Benchmark) · Lovful (Fast-Fashion DTC) · KISS USA (Retail Toàn Cầu)
              </p>
            </div>
          </div>
        ...
        <Card className="overflow-hidden border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-2xs animate-in fade-in duration-150">
            ...
            <table className="w-full text-left text-xs border-collapse min-w-[720px]">
              <thead>
                <tr className="bg-zinc-100/80 dark:bg-zinc-800/60 border-b border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-zinc-100 font-bold">
                  <th className="p-3.5 w-44 font-mono text-[11px] text-zinc-500 uppercase">Tiêu Chí So Sánh</th>
                  <th className="p-3.5 text-emerald-700 dark:text-emerald-400 border-l border-zinc-200 dark:border-zinc-800 bg-emerald-500/5">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge variant="outline" className="text-[9px] border-emerald-500/30 text-emerald-600 bg-emerald-500/10">Top 1 Benchmark</Badge>
                    </div>
                  </th>
                  <th className="p-3.5 text-purple-700 dark:text-purple-400 border-l border-zinc-200 dark:border-zinc-800 bg-purple-500/5">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge variant="outline" className="text-[9px] border-purple-500/30 text-purple-600 bg-purple-500/10">Fast-Fashion DTC</Badge>
                    </div>
                  </th>
                  <th className="p-3.5 text-blue-700 dark:text-blue-400 border-l border-zinc-200 dark:border-zinc-800 bg-blue-500/5">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge variant="outline" className="text-[9px] border-blue-500/30 text-blue-600 bg-blue-500/10">Retail Leader</Badge>
                    </div>
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800/80 text-zinc-700 dark:text-zinc-300">
                ...
                <tr className="hover:bg-zinc-50 dark:hover:bg-zinc-800/30">
                  <td className="p-3 font-semibold text-zinc-500 bg-zinc-50/50 dark:bg-zinc-900/50">Link Website</td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800">
                    <a href="https://nailhandy.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-emerald-600 dark:text-emerald-400 font-medium hover:underline">
                      <span>nailhandy.com</span>
                      <ExternalLink className="w-3 h-3" />
                    </a>
                  </td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800">
                    <a href="https://lovful.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-purple-600 dark:text-purple-400 font-medium hover:underline">
                      <span>lovful.com</span>
                      <ExternalLink className="w-3 h-3" />
                    </a>
                  </td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800">
                    <a href="https://www.kissusa.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-blue-600 dark:text-blue-400 font-medium hover:underline">
                ...
                {/* Row 2: Định vị */}
                <tr className="hover:bg-zinc-50 dark:hover:bg-zinc-800/30">
                  <td className="p-3 font-semibold text-zinc-500 bg-zinc-50/50 dark:bg-zinc-900/50">Định Vị &amp; Mô Hình</td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800 font-medium">Handmade Press-On Nails cao cấp (Dropship ➔ Micro-Brand)</td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800 font-medium">Trendy Acrylic Nails (Mẫu mã phong phú, bắt trend nhanh)</td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800 font-medium">Bring the Salon Home (Chuẩn mực bán lẻ toàn cầu, Omni-channel)</td>
                </tr>

                {/* Row 3: Tech Stack — CORRECTED 2026-08-28 qua PPSPY live-check, xem ghi chú trên COMPETITOR_BENCHMARK_STORES */}
                <tr className="hover:bg-zinc-50 dark:hover:bg-zinc-800/30">
                  <td className="p-3 font-semibold text-zinc-500 bg-zinc-50/50 dark:bg-zinc-900/50">Shopify Tech Stack</td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800 font-mono text-[11px]">
                    ...
                    <span className="text-zinc-500 block mt-1 font-sans">Theme custom — <strong>không</strong> xác nhận là Shrine PRO (claim cũ sai)</span>
                  </td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800 font-mono text-[11px]">
                    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded bg-zinc-200/60 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 font-bold">
                      "Prestige Theme (Luxury)"
                    </span>
                    <span className="text-zinc-500 block mt-1 font-sans">+ app PageFly Page Builder — <strong>không</strong> phải "Beae" (claim cũ sai)</span>
                  </td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800 font-mono text-[11px]">
                    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded bg-zinc-200/60 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 font-bold">
                      "shopify-kiss/main"
                    </span>
                    <span className="text-zinc-500 block mt-1 font-sans">Theme nội bộ tự dựng — <strong>không</strong> phải "Be Yours v8.3.3" (claim cũ sai)</span>
                  </td>
                </tr>

                {/* Row 4: Giá bán & COGS — CORRECTED 2026-08-28 qua PPSPY live-check */}
                <tr className="hover:bg-zinc-50 dark:hover:bg-zinc-800/30">
                  <td className="p-3 font-semibold text-zinc-500 bg-zinc-50/50 dark:bg-zinc-900/50">Giá Bán / COGS</td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800">
                    <strong className="text-zinc-900 dark:text-zinc-100">$24.95 – $270.53</strong> <span className="text-[10px] text-zinc-500">(avg $44.60)</span>
                    <div className="text-[10px] text-zinc-500">est_cogs PPSPY: công thức 25% giá bán, chưa sourced thật</div>
                  </td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800">
                    <strong className="text-zinc-900 dark:text-zinc-100">$33.99 – $37.99</strong> <span className="text-[10px] text-zinc-500">(avg $37.83)</span>
                    <div className="text-[10px] text-zinc-500">Gần gấp đôi con số $14.99-$22.99 đã ghi trước đó</div>
                  </td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800">
                    <strong className="text-zinc-900 dark:text-zinc-100">$3.99 – $100.00</strong> <span className="text-[10px] text-zinc-500">(avg $11.78)</span>
                    <div className="text-[10px] text-zinc-500">Có tier BYOB bundle tới $100, chưa từng ghi ở bản cũ</div>
                  </td>
                </tr>

                {/* Row 5: Margin — thay bằng disclaimer, không giữ số break-even CAC bịa */}
                <tr className="hover:bg-zinc-50 dark:hover:bg-zinc-800/30">
                  <td className="p-3 font-semibold text-zinc-500 bg-zinc-50/50 dark:bg-zinc-900/50">Biên Lợi Nhuận Gộp</td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800 text-[11px] text-zinc-500" colSpan={3}>
                    ⚠️ Không có báo giá supplier thật cho cả 3 store — số "78%/72%/65%" và "Break-even CAC $40/$32" ở bản cũ là suy diễn không có nguồn, đã bỏ. PPSPY chỉ trả về ước tính công thức chung (~75% cho mọi SKU), không đáng tin để so sánh cạnh tranh.
                  </td>
                </tr>

                {/* Row 6: Offer & Combo — hạ độ chắc chắn, các claim cụ thể (Mua 2 Tặng 1, giảm bậc thang %) chưa xác minh trực tiếp trên site */}
                <tr className="hover:bg-zinc-50 dark:hover:bg-zinc-800/30">
                  <td className="p-3 font-semibold text-zinc-500 bg-zinc-50/50 dark:bg-zinc-900/50">Offer &amp; Bundle</td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800 font-medium text-zinc-500 text-[11px]">
                    Bán theo bundle-set (vd 12-set $270.53) — cơ chế khuyến mãi cụ thể (Mua 2 Tặng 1?) <strong>chưa xác minh trực tiếp</strong> trên site
                  </td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800 font-medium text-zinc-500 text-[11px]">
                    Có tag giảm giá theo sự kiện ("SPRING Event Sale") — % giảm cụ thể <strong>chưa xác minh</strong>
                  </td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800 font-medium text-zinc-500 text-[11px]">
                    Có dòng "Build Your Own Bundle" giá cao — Subscribe &amp; Save <strong>chưa xác minh</strong>
                  </td>
                </tr>

                {/* Row 7: UX Triggers */}
                <tr className="hover:bg-zinc-50 dark:hover:bg-zinc-800/30">
                  <td className="p-3 font-semibold text-zinc-500 bg-zinc-50/50 dark:bg-zinc-900/50">UX &amp; Conversion Triggers</td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800 space-y-1">
                    <p className="font-semibold text-emerald-700 dark:text-emerald-400">• Bảng đo size móng (Nail Sizing Guide popup mm)</p>
                    <p>• Sticky Add to Cart bar kèm variant selector</p>
                    <p>• 100% review kèm ảnh thực tế bàn tay khách</p>
                  </td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800 space-y-1">
                    <p>• Bộ lọc trực quan theo Shape (Almond, Coffin) &amp; Length</p>
                ...
                <tr className="hover:bg-zinc-50 dark:hover:bg-zinc-800/30">
                  <td className="p-3 font-semibold text-zinc-500 bg-zinc-50/50 dark:bg-zinc-900/50">
                    ...
                    <div className="text-[10px] text-rose-500 font-normal mt-0.5">Sức khỏe Ads Library</div>
                  </td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800 space-y-1.5">
                    <div>
                      <span className="px-1.5 py-0.5 rounded bg-amber-500/10 text-amber-700 dark:text-amber-400 font-bold text-[10px]">
                        ⚠️ Số ads "83" (bản cũ) CHƯA XÁC MINH — PPSPY không trả về số ads
                      </span>
                      <p className="font-medium text-zinc-600 dark:text-zinc-400 mt-1">
                        Xác nhận thật (PPSPY): Meta Pixel + TikTok Pixel đều Active. Câu hook "Spending $120 at salon..." <strong>chưa xác minh trực tiếp</strong>.
                      </p>
                    </div>
                    <div className="flex flex-col gap-1 text-[10px]">
                      ...
                      >
                        <span>🔍 Tự check Meta Ads Library (số thật cần xem tay)</span>
                  ...
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800 space-y-1.5">
                    <div>
                      <span className="px-1.5 py-0.5 rounded bg-amber-500/10 text-amber-700 dark:text-amber-400 font-bold text-[10px]">
                        ⚠️ Claim "0 Ads / 100% TikTok" SAI — PPSPY xác nhận Meta Pixel Active
                      </span>
                      <p className="font-medium text-zinc-600 dark:text-zinc-400 mt-1">
                        Có Meta Pixel + TikTok Pixel đều Active thật — không thể kết luận Lovful chỉ chạy TikTok.
                      </p>
                    </div>
                    <div className="flex flex-col gap-1 text-[10px]">
                      <a
                  ...
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800 space-y-1.5">
                    <div>
                      ...
                      <p className="font-medium text-blue-700 dark:text-blue-400 mt-1">
                        Pixel Active thật (PPSPY) — page ads cụ thể (Kiss Nails/imPRESS) &amp; Google Search Ads <strong>chưa xác minh trực tiếp</strong>.
                      </p>
                    </div>
                    <div className="flex flex-col gap-1 text-[10px]">
                      <a
                ...
                <tr className="hover:bg-zinc-50 dark:hover:bg-zinc-800/30">
                  <td className="p-3 font-semibold text-zinc-500 bg-zinc-50/50 dark:bg-zinc-900/50">Logistics &amp; Vận Chuyển</td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800 text-zinc-500 text-[11px]" colSpan={3}>
                    ⚠️ Chưa có nguồn thật cho cả 3 store (PPSPY không trả dữ liệu logistics). Các mô tả "YunExpress 7-10 ngày", "kho nội địa Mỹ"... ở bản cũ là suy diễn theo mô hình chung ngành, chưa xác minh riêng cho từng store — không dùng để quyết định chọn 3PL.
                  </td>
                </tr>
                ...
                <tr className="bg-amber-500/5 dark:bg-amber-500/5 border-t-2 border-amber-500/20">
                  <td className="p-3 font-bold text-amber-700 dark:text-amber-400">💡 Bài Học Áp Dụng Cho Store</td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800 text-[11px] font-semibold text-zinc-900 dark:text-zinc-100">
                    Định vị theo bundle-set giá cao (không bán lẻ giá thấp) — đây là tín hiệu sourced đáng tin từ pricing thật.
                  </td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800 text-[11px] text-zinc-700 dark:text-zinc-300">
                    Giá thật ($33-38) gần NailHandy hơn nhiều so với ghi chú cũ — đừng định giá thấp cho ngách này.
                  </td>
                  <td className="p-3 border-l border-zinc-200 dark:border-zinc-800 text-[11px] text-zinc-700 dark:text-zinc-300">
                    Brand retail lớn, giá thấp SKU rộng — mức tham khảo cho 1 store solo mới thấp hơn 2 store kia.
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div className="p-3.5 bg-zinc-50 dark:bg-zinc-900/80 border-t border-zinc-200 dark:border-zinc-800 text-xs space-y-1.5">
            <div className="flex items-center gap-2 font-bold text-zinc-900 dark:text-zinc-100">
              <span className="p-1 rounded bg-rose-500/10 text-rose-600 dark:text-rose-400 font-mono text-[10px]">INTEL</span>
              <span>📌 Nguyên Tắc Đo Lường Sức Khỏe Tài Chính Qua Meta Ads Library (Tín Hiệu Sống Còn):</span>
            </div>
            <p className="text-zinc-600 dark:text-zinc-400 pl-6 leading-relaxed">
              Trong Dropshipping, doanh thu (Revenue) chỉ là bề nổi — quan trọng nhất là <strong>đối thủ có đang có lãi để duy trì Ads hay không</strong>:
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 pl-6 pt-1">
              <div className="p-2.5 rounded-lg bg-emerald-500/5 border border-emerald-500/20 text-emerald-800 dark:text-emerald-300 text-[11px] space-y-1">
                <strong>🟢 Tín hiệu Có Lãi &amp; Sinh Lời (ROAS dương, Dòng tiền mạnh):</strong>
                <p className="text-zinc-600 dark:text-zinc-400">
                  Duy trì <strong>15–30+ Ad Creatives active liên tục &gt; 30–60 ngày</strong>. Đối thủ liên tục bơm tiền và mở rộng ad set mà không tắt chứng minh ROAS &gt; Break-even CAC. (Nguyên tắc chung — chưa áp dụng số thật cho NailHandy/Lovful/KISS vì chưa check tay Meta Ads Library.)
                </p>
              </div>
              <div className="p-2.5 rounded-lg bg-rose-500/5 border border-rose-500/20 text-rose-800 dark:text-rose-300 text-[11px] space-y-1">
                <strong>🔴 Tín hiệu Cắt Lỗ / Bão Hòa (Ad Fatigue, Scale hụt):</strong>
                <p className="text-zinc-600 dark:text-zinc-400">
                  Số lượng Ad Sets active tụt dốc dưới 5 ads, hoặc chỉ lên test 1–2 ads rồi tắt sau 2–3 ngày ➔ Dấu hiệu CPA vượt trần, chiến dịch lỗ và store đang tắt camp cắt lỗ.
                </p>
              </div>
            </div>
          </div>
            ...
            >
              <div className="space-y-3.5">
                ...
                <div className="flex items-start justify-between gap-2">
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <Badge variant="outline" className="text-[9px] font-mono px-1.5 py-0.5 border-emerald-500/30 text-emerald-600 bg-emerald-500/10">
                        ★ {store.rating}
                      </Badge>
                    </div>
                ...
                <div className="space-y-2 text-xs divide-y divide-zinc-100 dark:divide-zinc-800/80">
                  <div className="pt-1.5 flex items-start justify-between gap-2">
                    <span className="text-zinc-500 shrink-0 flex items-center gap-1">
                      <Zap className="w-3.5 h-3.5 text-amber-500" /> Giá Bán / COGS:
                    </span>
                    <span className="font-bold text-right text-zinc-900 dark:text-zinc-100">
                      {store.pricing} <br />
                      <span className="text-[10px] font-normal text-zinc-500">COGS: {store.cogs}</span>
                    </span>
                  </div>

                  <div className="pt-1.5 flex items-start justify-between gap-2">
                    <span className="text-zinc-500 shrink-0 flex items-center gap-1">
                      <TrendingUp className="w-3.5 h-3.5 text-emerald-500" /> Biên Lợi Nhuận:
                    </span>
                  ...
                  <div className="pt-1.5 flex items-start justify-between gap-2">
                    <span className="text-zinc-500 shrink-0 flex items-center gap-1">
                      <Layers className="w-3.5 h-3.5 text-indigo-500" /> Shopify Tech Stack:
                    </span>
                  ...
                  <div className="pt-1.5 flex items-start justify-between gap-2">
                    <span className="text-zinc-500 shrink-0 flex items-center gap-1">
                      <Truck className="w-3.5 h-3.5 text-blue-500" /> Logistics &amp; Ship:
                    </span>
                ...
                <div className="space-y-1.5 pt-1.5 border-t border-zinc-100 dark:border-zinc-800/80">
                  <span className="text-[11px] font-bold text-zinc-800 dark:text-zinc-200 flex items-center gap-1">
                    <Search className="w-3.5 h-3.5 text-rose-500" /> Ad Creatives &amp; Hook Links:
                  </span>
              ...
              <div className="pt-2 border-t border-zinc-100 dark:border-zinc-800">
                <p className="text-[11px] text-zinc-700 dark:text-zinc-300 bg-amber-500/10 dark:bg-amber-500/5 p-2 rounded-md border border-amber-500/20 leading-relaxed">
                  <strong className="text-amber-700 dark:text-amber-400">💡 Bài học áp dụng: </strong>
                  {store.takeaway}
                </p>
              </div>
            </Card>
    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between px-1">
        <p className="text-[11px] font-mono text-zinc-500">
          Nhật ký {MARKET_RESEARCH_DAILY_LOGS.length} ngày (Mặc định mở ngày mới nhất)
        </p>
        <div className="flex items-center gap-2">
          <Button
            variant="ghost"
        ...
        <div className="flex items-center justify-between gap-3 p-3 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50/80 dark:bg-zinc-900/50 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {showDoc ? (
                <>
                  <ChevronDown className="w-3.5 h-3.5 mr-1.5 text-zinc-500" /> Thu gọn Nhật Ký
                </>
              ) : (
                <>
                  <ChevronRight className="w-3.5 h-3.5 mr-1.5 text-emerald-600 dark:text-emerald-400" /> 📅 Xem Nhật Ký Hàng Ngày
                </>
              )}
            </Button>
        ...
        <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
          ...
          <div className="space-y-4 text-xs text-zinc-700 dark:text-zinc-300 pt-2">
            <p className="text-zinc-500 dark:text-zinc-400 leading-relaxed">
              Vấn đề trước đây không phải thiếu nguồn — là 4 nhóm/12+ nguồn thì không biết đọc
              cái nào trước. Rút còn 3 nhóm, mỗi nhóm có <strong>nhịp đọc riêng</strong> — nhóm 1
              xem 1 lần/tuần đủ, nhóm 2 lướt khi rảnh, nhóm 3 chỉ mở khi cần quyết định (không
              phải nguồn "đọc tin").
            </p>
            ...
            <div className="space-y-3">
              ...
              <div className="p-3.5 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50/70 dark:bg-zinc-900/50 space-y-1.5">
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2 font-bold text-zinc-900 dark:text-zinc-100">
                    ...
                    <span>🌐 Tin tức & chính sách nền tảng (Shopify · Meta · TikTok · fulfillment)</span>
                  </div>
                  <Badge variant="outline" className="text-[9px] shrink-0 border-blue-500/30 text-blue-600 bg-blue-500/10">1×/tuần</Badge>
                </div>
                <div className="text-[11px] text-zinc-600 dark:text-zinc-400 pl-7 space-y-1 leading-relaxed">
                  <p>• <strong>Shopify Changelog</strong>: <a href="https://changelog.shopify.com/" target="_blank" rel="noopener noreferrer" className="text-emerald-600 dark:text-emerald-400 underline">changelog.shopify.com</a> — thứ duy nhất thực sự ảnh hưởng ngay tới store (vd đợt đóng Additional Scripts đã ghi trong log 27/08).</p>
                  <p>• <strong>Meta Business Help/Newsroom</strong>: <a href="https://www.facebook.com/business/help/" target="_blank" rel="noopener noreferrer" className="text-emerald-600 dark:text-emerald-400 underline">facebook.com/business/help</a> — chính sách Pixel/Ads thay đổi (vd Andromeda/ASC).</p>
                  <p>• <strong>TikTok for Business Newsroom</strong>: <a href="https://newsroom.tiktok.com/" target="_blank" rel="noopener noreferrer" className="text-emerald-600 dark:text-emerald-400 underline">newsroom.tiktok.com</a> — chính sách creator/ads.</p>
                  <p>• <strong>Fulfillment</strong>: trang tin YunExpress/CJ Dropshipping — chỉ xem khi chuẩn bị chọn/đổi 3PL, không phải nguồn đọc định kỳ.</p>
                </div>
              </div>
              ...
              <div className="p-3.5 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50/70 dark:bg-zinc-900/50 space-y-1.5">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <Badge variant="outline" className="text-[9px] shrink-0 border-blue-500/30 text-blue-600 bg-blue-500/10">Lướt khi rảnh</Badge>
                </div>
                <div className="text-[11px] text-zinc-600 dark:text-zinc-400 pl-7 space-y-1.5 leading-relaxed">
                  <p>
                    Đang follow 3 người (Bảo Nam Kimchi, Hùng Tóc Trưởng, Anhstein MMO) + 1{" "}
                    <a href="https://www.facebook.com/groups/296787476078292/?sorting_setting=CHRONOLOGICAL" target="_blank" rel="noopener noreferrer" className="text-emerald-600 dark:text-emerald-400 underline">FB Group Dropship VN</a>.
                    Mình không có cách kiểm chứng độc lập ai trong 3 người đó đáng tin hơn ai — không tự xếp hạng hộ được.
                  </p>
                  <p className="font-semibold text-zinc-700 dark:text-zinc-300">
                    Cách chọn thực tế hơn: áp cùng rule cắt lỗ đang dùng cho sản phẩm — theo dõi cả
                    3 trong 2 tuần, ai <strong>không đưa ra nổi 1 thông tin áp dụng được vào việc
                    đang làm</strong> thì bỏ, chỉ giữ lại 1 người + group để đọc đều. 3 người + 1
              ...
              <div className="p-3.5 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50/70 dark:bg-zinc-900/50 space-y-1.5">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <Badge variant="outline" className="text-[9px] shrink-0 border-blue-500/30 text-blue-600 bg-blue-500/10">Mở khi cần quyết định</Badge>
                </div>
                <div className="text-[11px] text-zinc-600 dark:text-zinc-400 pl-7 space-y-1 leading-relaxed">
                  <p>• <strong className="text-emerald-700 dark:text-emerald-400">PPSPY (đã dùng, hiệu quả nhất)</strong>: live-check store đối thủ (theme/app/pixel/giá thật) — chính công cụ này đã bắt được số liệu bịa trong nhật ký 28/08. Dùng trước khi tin bất kỳ claim nào về đối thủ.</p>
                  <p>• <strong>Meta Ads Library + TikTok Creative Center</strong>: đã dùng đúng cách trong 3 báo cáo verified (Car Accessories/Sustainability/Child &amp; Baby) — luôn mở live, ghi ngày giờ, không suy diễn từ trí nhớ.</p>
                  <p>• <strong>Claude/ChatGPT</strong>: viết/rà lại nội dung, KHÔNG dùng để tự bịa số liệu thị trường thay cho việc mở nguồn thật (đúng bài học từ báo cáo Nails).</p>
                  <p>• <strong>CapCut / Canva</strong>: dựng creative — chỉ cần khi đã có sản phẩm mẫu thật trong tay để quay.</p>
                </div>
              </div>
            </div>
          </div>
