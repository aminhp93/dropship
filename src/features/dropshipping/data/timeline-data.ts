...
export const GATES: Gate[] = [
  ...
  },
  {
    ...
    budget: 500,
    purpose: 'Chứng minh có người muốn mua, bằng organic TikTok trước khi trả tiền ads.',
...
export const DAILY_LOG_SEED: DailyLogEntry[] = [
  { id: 'seed-2026-08-05', date: '2026-08-05', summary: 'Học buổi 1 Ngô Thành Ecom — Giới thiệu dropship vs POD', category: 'hoc', alignment: 'support', source: 'git' },
  { id: 'seed-2026-08-09', date: '2026-08-09', summary: 'Học buổi 2 — Sản phẩm', category: 'hoc', alignment: 'support', source: 'git' },
  { id: 'seed-2026-08-10', date: '2026-08-10', summary: 'Làm 2 báo cáo research ngách: Car Accessories + Sustainability', category: 'research', alignment: 'support', source: 'git' },
  { id: 'seed-2026-08-12', date: '2026-08-12', summary: 'Học buổi 3 — Store', category: 'hoc', alignment: 'support', source: 'git' },
  { id: 'seed-2026-08-15', date: '2026-08-15', summary: 'Khởi tạo dashboard dropship-web + cấu trúc SOP/playbook 2026', category: 'tooling', alignment: 'detour', source: 'git' },
  { id: 'seed-2026-08-16', date: '2026-08-16', summary: 'Xây PPSPY Dashboard, Market Research Tool, restructure routes (21 commit/ngày)', category: 'tooling', alignment: 'detour', source: 'git' },
  { id: 'seed-2026-08-17', date: '2026-08-17', summary: 'Dựng workflow + agents cho video creative', category: 'tooling', alignment: 'detour', source: 'git' },
  { id: 'seed-2026-08-18', date: '2026-08-18', summary: 'Refactor routes, viết agent skills cho ecom workflow', category: 'tooling', alignment: 'detour', source: 'git' },
  { id: 'seed-2026-08-19', date: '2026-08-19', summary: 'Research Essential Oil Diffusers; nhận ra quy trình market research chưa rõ; đẩy mạnh video AI', category: 'research', alignment: 'support', source: 'file' },
  { id: 'seed-2026-08-20', date: '2026-08-20', summary: 'Chốt tiêu chí chọn sản phẩm (không local brand, không trend); quyết định clone 1 store làm mẫu', category: 'research', alignment: 'direct', source: 'file' },
  { id: 'seed-2026-08-21', date: '2026-08-21', summary: 'Viết task clone store + task tạo video', category: 'tooling', alignment: 'detour', source: 'git' },
  { id: 'seed-2026-08-23', date: '2026-08-23', summary: 'Gom file tiến độ; CHỐT sản phẩm: đèn dây macrame/boho (Ngày 1 tuần 1)', category: 'research', alignment: 'direct', source: 'git' },
  { id: 'seed-2026-08-24', date: '2026-08-24', summary: 'Quy trình clone store + checklist review; khởi tạo Daily Log Agent & CLI', category: 'store', alignment: 'support', source: 'file' },
  { id: 'seed-2026-08-25', date: '2026-08-25', summary: 'Store issue: ảnh bản quyền, product/collection phải làm tay; review quy trình Ngô Thành Ecom', category: 'store', alignment: 'support', source: 'file' },
  { id: 'seed-2026-08-26', date: '2026-08-26', summary: 'Gen ảnh từ store đối thủ (ChatGPT cho kết quả tốt nhất, móng tay khó nhất)', category: 'content', alignment: 'support', source: 'file' },
];
